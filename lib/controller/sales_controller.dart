...
import 'package:pos_system/model/chart_data.dart';
import 'package:pos_system/model/coupon.dart';
import 'package:pos_system/model/daily_order_data.dart';
import 'package:pos_system/model/monthly_data.dart';
import 'package:pos_system/model/order_and_total.dart';
...
class SalesController extends GetxController {
  ...
  final AllController _controller = Get.find();
  ...
  @override
  void onInit() async {
    _controller.firestore.getDaysInCurrentMonthList().then((value) {
    ...
    _controller.firestore.getMonthlySalesData().then((value) {
      monthlyDataList.value =
          value.docs.map((e) => MonthlyData.fromJson(e.data())).toList();
      int index = 0;
